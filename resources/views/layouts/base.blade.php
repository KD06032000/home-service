...
<head>
    <meta charset="utf-8">
    <title>Vingroup - Online Service Provider for your House Needs</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            ...
                            <li><a href="mailto:kieudao0603@gmail.com"><i class="fa fa-envelope"></i>
                                kieudao0603@gmail.com</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            ...
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i>Hanoi,VietNam</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> Live Chat</li>
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> HaNoi,VietNam</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    ...
                    <li> <a href="{{ route('home.service_categorories') }}">Service Categories</a></li>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> Hanoi,VietNam</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:kieudao0603@gmail.com">kieudao0603@gmail.com</a>
                            </li>
                            <li>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@surfsidemedia.in">kieudao0603@gmail.com</a>
                            </li>
                            <li>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2021 Vingroup. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>                
            </div>            
