                                        ...
                                        @foreach ($scategories as $scategory )
                                            <tr>
                                                ...
                                                <td >
                                                    ...
                                                    <a href="" onclick="confirm('Are you sure,you want to delete this service category!')|| event.stopImediatePropagation()" wire:click.prevent="deleteServiceCategory({{ $scategory->id }})" style="margin-left:10px;"><i class="fa fa-times fa-2x text-danger"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
