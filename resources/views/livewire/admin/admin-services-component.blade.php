                                        ...
                                        @foreach ($services as $service )
                                            <tr>
                                                ...
                                                <td >
                                                    ...
                                                    <a href="#" onclick="confirm('Are you sure,you want to delete this service')|| event.stopImmediatePropagation()"  wire:click.prvent= "deleteService{{ $service_id }}" style="margin-left:10px;"><i class="fa fa-times fa-2x text-danger"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
