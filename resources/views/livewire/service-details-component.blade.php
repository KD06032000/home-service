                                    ...
                                    <div class="col-md-12">
                                        <div class="post-content">
                                            ...
                                            <ul class="list-styles">
                                                @foreach (exlode("|",$service->inclustion) as $inclustion)
                                                    <li><i class = "fa fa-plus"></i>{{ $inclustion }}</li>
                                                @endforeach
                                               
                                            </ul>
                                            <h4>Exclusion</h4>
                                            <ul class="list-styles">
                                                @foreach (explode("|",$service->exclustion) as $exclustion )
                                                    <li><i class = "fa fa-minus"></i>{{ $exclustion }}</li>            
                                                @endforeach
